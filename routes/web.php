...
Route::get('/flyers', [App\Http\Controllers\FlyerController::class, 'flyers'])->name('flyers');

Route::get('/flyers/create', [App\Http\Controllers\FlyerController::class, 'flyersCreate'])->name('flyers.create');

Route::get('/flyers/edit/{id}', [App\Http\Controllers\FlyerController::class, 'flyersEdit'])->name('flyers.edit');
